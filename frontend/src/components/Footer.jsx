    ...
    <footer style={{ backgroundColor: "rgb(250, 250, 250)" }}>
      <div className="container border-top mt-5">
        <div className="row mt-5">
          <div className="col">
            ...
            <div className='fs-4 text-muted'>
              <i class="fa fa-twitter" aria-hidden="true" style={{marginLeft: "1px"}}></i>
              <i class="fa fa-facebook-official" aria-hidden="true" style={{marginLeft: "20px"}}></i>
              <i class="fa fa-instagram" aria-hidden="true" style={{marginLeft: "20px"}}></i>
              <i class="fa fa-linkedin" aria-hidden="true" style={{marginLeft: "20px"}}></i>
              <i class="fa fa-telegram" aria-hidden="true" style={{marginLeft: "20px"}}></i>
            </div>
          </div>
          <div className="col">
            <p>Company</p>
        ...
        <div className="mt-5" style={{ fontSize: "14px" }}>
          <p>
            Zerodha Broking Ltd.: Member of NSE​ &amp;​ BSE &ndash; SEBI Registration no.:
            INZ000031633 CDSL: Depository services through Zerodha Securities
            Pvt. Ltd. &ndash; SEBI Registration no.: IN-DP-100-2015 Commodity Trading
            through Zerodha Commodities Pvt. Ltd. MCX: 46025 &ndash; SEBI Registration
